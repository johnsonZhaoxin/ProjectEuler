#源代码来自 https://pretagteam.com/question/project-euler-18-in-python-beginner
...
for i in range(1, len(number)):
   number[i] = number[i].strip().split(' ') #按照空格分割
   number[i] = list(int(x) for x in number[i])
